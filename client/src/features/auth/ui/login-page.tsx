...
import { loginSchema, LoginSchemaType, useLoginMutation } from "@/features/auth";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (values: LoginSchemaType) => {
    const result = await login({ identifier: values.identifier, password: values.password }).catch(() => null);
