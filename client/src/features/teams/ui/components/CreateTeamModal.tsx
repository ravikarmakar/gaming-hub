  ...
  return (
    <Dialog open={isCreateTeamOpen} onOpenChange={setIsCreateTeamOpen}>
      <DialogContent
        ...
        className="sm:max-w-[480px] p-0 overflow-hidden bg-[#0F111A] border-purple-500/20 shadow-[0_0_50px_rgba(139,92,246,0.15)] rounded-2xl"
      >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="px-6 pb-6 pt-2">
            <div className="space-y-4">
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent className="bg-[#0F111A] border-white/10 text-purple-100">
              ...
              <div className="space-y-3 pt-2">
                {error && (
                  <div className="flex items-start gap-2 p-2 rounded-lg bg-red-500/10 border border-red-500/20 animate-in fade-in slide-in-from-top-1">
