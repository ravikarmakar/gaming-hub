...
import { User, Check, X, MessageSquare, Clock, Trash2 } from 'lucide-react';
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <TeamPageHeader
                ...
                actions={
                    <Button
                        ...
                        disabled={isLoading || isClearing || !hasRequests}
            ...
            <ConfirmActionDialog
                ...
                description={`This action will permanently reject all ${joinRequests?.length || 0} pending applications. Every applicant will be notified that their request was declined. This action cannot be undone.`}
                actionLabel="Decline All Requests"
