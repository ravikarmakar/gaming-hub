...
const OrganizerManagementPage = () => {
    ...
    const organizers = entities as any[]; // Type cast for simplicity in UI

    useEffect(() => {
        fetchEntities("Organizer", currentPage, activeTab, searchQuery);
    }, []);
                ...
                <GlassCard className="overflow-hidden border-white/5 p-0">
                                            ...
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="bg-[#16161c] border-white/10 text-white shadow-2xl">
                                                    <DropdownMenuItem
                                                        ...
                                                        onClick={() => updateEntityStatus("Organizer", org._id, { isBlocked: !org.isBlocked })}
                                                    >
                                                        {org.isBlocked ? (
                                                            <>
                    ...
                    <div className="px-6 py-4 border-t border-white/5 flex items-center justify-between bg-white/[0.01]">
                        <p className="text-xs text-gray-500 font-medium">
                            Showing <span className="text-white">{(currentPage - 1) * pageSize + 1}</span> to <span className="text-white">{Math.min(currentPage * pageSize, totalEntities)}</span> of <span className="text-white">{totalEntities}</span> organizers
                        </p>
                        <div className="flex items-center gap-2">
                            <Button
                                variant="outline"
