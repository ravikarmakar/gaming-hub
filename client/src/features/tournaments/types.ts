...
export type RoundTabType = "tournament" | "invited-tournament" | "t1-special";
export type LeaguePairingType = 'AxB' | 'BxC' | 'AxC';
...
export interface Tournament {
    ...
    roadmaps?: Array<{ type: RoadmapTrackType; data: RoadmapItem[] }>;
    hasInvitedTeams?: boolean;
    hasT1SpecialTeams?: boolean;
    hasMappings?: boolean;
    is18TeamLeague?: boolean;
...
export interface MergeSource {
    ...
    pairingType?: LeaguePairingType | null;
}

export interface MergeInfo {
    type: 'merges-into' | 'receives-from';
    targetLabel?: string;
    targetTitle?: string;
    targetIndex?: number;
    sources?: MergeSource[];
    hasInvitedMapping?: boolean;
    hasT1Mapping?: boolean;
}

export interface RoadmapDisplayItem extends Omit<Round, 'mergeInfo'> {
    roadmapIndex: number;
    roadmapData: RoadmapItem | undefined;
    isDisabled: boolean;
