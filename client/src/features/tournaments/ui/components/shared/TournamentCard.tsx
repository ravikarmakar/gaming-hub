...
import { Users, Gamepad2, TrendingUp, ArrowRight } from "lucide-react";
        ...
        <div className="p-2 sm:p-4 xl:p-6 flex-1 flex flex-col min-w-0">
          ...
          {!hideViewDetails && (
            <div className="mt-auto pt-4 border-t border-white/5">
              <Button
                variant="outline"
                className="w-full group/btn border-purple-500/20 text-purple-400 hover:bg-purple-500/10 hover:border-purple-500/50 transition-all font-bold text-[10px] xl:text-xs uppercase tracking-[0.2em] gap-2 h-9 xl:h-11 rounded-xl"
              >
                View Details
