...
import { categoryOptions, tournamentTypeOptions, registrationModeOptions, TournamentFormValues, GAMES_MAPS } from "@/features/tournaments/lib";
import { Category, RegistrationMode } from "@/features/tournaments/types";
