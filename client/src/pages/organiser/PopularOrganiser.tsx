    ...
    <section className="py-20 bg-black relative overflow-hidden">
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-violet-900 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-amber-400 via-orange-500 to-red-600">
              Elite Tournament Organizers
            </h2>
            <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
              Join the most prestigious gaming communities led by top-tier
              organizers.
            </p>
          </motion.div>
